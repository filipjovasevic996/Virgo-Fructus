...
export const metadata: Metadata = {
  ...
  description:
    'Premium dehidrirano voće iz Beograda za koktele, dekoraciju pića i zdravu užinu. Sušenje voća na niskim temperaturama — 100% prirodno, bez aditiva. Besplatna dostava u Srbiji za narudžbine preko 4000 RSD.',
  keywords: [
    'dehidrirano voće',
    'sušeno voće',
    'sušenje voća',
