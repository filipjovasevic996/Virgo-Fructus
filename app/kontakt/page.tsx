          ...
          <div className="space-y-8 lg:pt-20">
            ...
            {/* <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1 font-sans text-text-nav">
                  {t('contact.weekdays')}
                </p>
                <p className="font-sans text-text-nav">
                  {t('contact.saturday')}
                </p>
                <p className="font-sans text-sm text-text-nav/70">
                  {t('contact.sunday')}
                </p>
              </div>
            </div> */}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <input
                    ...
                    onBlur={() => {
                      if (!formData.name.trim()) {
                        setErrors({ ...errors, name: t('contact.errorName') })
                      } else {
                  ...
                  <input
                    ...
                    onBlur={() => {
                      if (!formData.email.trim()) {
                        setErrors({ ...errors, email: t('contact.errorEmail') })
                      } else {
                ...
                <div>
                  ...
                  <select
                    ...
                    onBlur={() => {
                      if (!formData.topic) {
                        setErrors({ ...errors, topic: t('contact.errorTopic') })
                      } else {
                        const { topic: _, ...rest } = errors
                        setErrors(rest)
                      }
                    }}
                    className="input-vigor w-full px-4 py-3"
                  ...
                  <textarea
                    ...
                    onBlur={() => {
                      if (!formData.message.trim()) {
                        setErrors({ ...errors, message: t('contact.errorMessage') })
                      } else {
