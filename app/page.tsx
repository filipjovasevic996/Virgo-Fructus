      ...
      <section className="relative min-h-[70vh] sm:min-h-[80vh] lg:min-h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-[900px] px-5 sm:px-6 lg:px-8 py-14 sm:py-20 lg:py-28 text-center">
          ...
          <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4">
            <Link
              href="/prodavnica"
              className="inline-flex items-center justify-center px-7 sm:px-8 py-3 sm:py-3.5 bg-lime text-bg-dark font-sans text-[12px] font-semibold uppercase tracking-[0.08em] rounded hover:bg-cream transition-colors shadow-lg"
            >
              {t('home.orderNow')}
            </Link>
            <Link
              href="/nasa-prica"
              className="inline-flex items-center justify-center px-7 sm:px-8 py-3 sm:py-3.5 bg-transparent text-white font-sans text-[12px] font-semibold uppercase tracking-[0.08em] border-[1.5px] border-white/40 rounded hover:border-white hover:bg-white/10 transition-colors"
            >
              {t('home.ourStoryLink')}
            </Link>
          </div>
        ...
        <div className="mx-auto max-w-[1320px] px-5 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-8 sm:mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center">
              ...
              <p className="mt-2 font-sans text-xs sm:text-sm text-text-body-light leading-relaxed max-w-xs">
                {t('home.naturalDesc')}
              </p>
            </div>
